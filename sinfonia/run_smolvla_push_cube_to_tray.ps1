# ── Evaluar SmolVLA en MuJoCo — push_cube_to_tray (joystick) ─────────────────
# Escena: cubo en el suelo (y=0) → empujar hacia bandeja destino (y=0.25).
# Usa XML dedicado (so101_push_cube_to_tray.xml), NO so101_camera_mount.xml.
# Para grabar demos: record_push_cube_to_tray_joystick.ps1
#
# Uso:
#   .\run_smolvla_push_cube_to_tray.ps1
...
$EVAL_REPO = "local/eval_smolvla_push_cube_to_tray_${RUN_TAG}"
