...
OUTPUT_SUBDIR = f"train/xvla_merged_{_RUN_TAG}"
JOB_NAME = f"xvla_merged_{_RUN_TAG}"
HUB_REPO_ID = f"Celeste-02/xvla-so101-merged-4-tasks-{_RUN_TAG}-v1.0"
...
image = (
    ...
    .pip_install(
        f"lerobot[xvla]=={LEROBOT_VERSION}",
        "huggingface_hub",
        "wandb",
        "matplotlib",
        "pandas",
